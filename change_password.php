...
?>
	...
	<div class="form-box">
		...
		<p>Changing Password for <?php echo $user_details[1];?>. Not you? <a href='logout.php'>Logout</a>.</p>
<?php	
			...
			if (!empty($_POST)){
				...
				if (empty($auth_errors)){
					...
					//sql queries
					if (!empty($new_password)){
						$q_edit_pw = "UPDATE users SET u_password = '$new_hashed_pw' WHERE u_email LIKE '$session_email'";
					...
					if (empty($update_errors)){
						...
						header('Location: control_panel.php?successfulPassChange=true');
